    ...
    private  void worker1() {
        ...
        while (true) {
            try{
                ...
                System.out.println("Worker 1 gets lock1");
            ...
            if (lock2.tryLock()) {
                ...
                System.out.println("Worker 1 cannot get lock2");
                continue;
            }
            break;
    ...
    private  void worker2() {
        while (true) {
            try{
                ...
                System.out.println("Worker 2 gets lock2");
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            ...
            if (lock1.tryLock()) {
                System.out.println("Worker 2 gets lock1");
                lock1.unlock();
            } else {
                System.out.println("Worker 2 cannot get lock1");
                continue;
            }
            break;
